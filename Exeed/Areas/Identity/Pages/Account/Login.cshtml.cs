...
namespace Exeed.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, AccountManager accountManager)
        {
        ...
        {
            returnUrl ??= Url.Content("~/Identity/Account/Manage/Star");
